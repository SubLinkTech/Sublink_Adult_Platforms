...
if [ -f "builds/SubLink_Adult-$VERSION-win-x64.zip" ]; then
    rm "builds/SubLink_Adult-$VERSION-win-x64.zip"
fi

zip -r -9 "builds/SubLink_Adult-$VERSION-win-x64.zip" "$BUILD_DIR/"
